    ...
    <header className="sticky top-0 z-30 border-b border-[var(--line)] bg-white/95 backdrop-blur">
      <div className="mx-auto flex min-h-16 max-w-7xl items-center justify-between gap-3 px-4 sm:px-6 lg:px-8">
        ...
        <nav className="flex items-center gap-1 sm:gap-2" aria-label="Primary navigation">
          ...
          <Link href="/my-appointments" className="rounded-lg px-2.5 py-2 text-xs font-semibold text-[var(--muted)] hover:bg-stone-100 hover:text-[var(--ink)] sm:px-3 sm:text-sm">My Appointments</Link>
          ...
          {ready && auth ? <NotificationBell audience="user" /> : null}
          {ready && auth ? (
